...
2.  Библиотека, где автор возможно подумал о такое же релизации и Ваша библиотека возможно будет плохо с ней взаимодействовать.

3.  Библиотека, где автор реализует такой функционал позже и Ваша библиотека потеряет совместимость.
...
Следующий синтакс: `object[name]` позволяет использовать буквально любую строчку в качестве имени свойства. Это будет работать: коллизии практически невозможны, и код выглядит намного лучше.
