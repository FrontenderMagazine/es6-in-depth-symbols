...
Набор значений типа Объект неограничен. Каждый объект является уникальным. Каждый раз при открытии веб страницы создается множество новых объектов.
...
Если вы все еще сомневаетесь в полезности символов, следующий раздел будет вам интересен, потому что в нем показано, как символы доказали свою полезность на практике.
