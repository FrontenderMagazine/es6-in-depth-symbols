...
С тех пор как JavaScript был впервые стандартизирован в 1997 году, в нем было только 6 типов. До ES6 каждое значение в JS приложении попадало в одну из категорий:
